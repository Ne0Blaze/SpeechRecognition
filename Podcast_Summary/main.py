...
import glob
import json
from apiConnect import save_transcript


#creating a web application to show podcast summary using Assembly AI and Listen Notes
...
button= st.sidebar.button("Download Episode Aummary", on_click=save_transcript, args=(episode_id,))


#creating clean time stamps using start and end in json file
